...
LOGIN_WEB_URI_CN = "https://id.mercedes-benz.com.cn"
...
CIAM_DEVICE_WEB_LOGIN_URL_CN = f"{LOGIN_WEB_URI_CN}/login"
CIAM_DEVICE_WEB_VERIFY_URL_CN = f"{LOGIN_WEB_URI_CN}/api/v1/auth/device"
...
SERVICE_CHARGE_COUPLER_STOP = "charge_coupler_stop"
...
UNITS = {
    ...
    "KM_PER_KWH": UnitOfEnergyDistance.KM_PER_KILO_WATT_HOUR,
    "KM_PER_LITER": UnitOfLength.KILOMETERS + "/" + UnitOfVolume.LITERS,
    "KPA": UnitOfPressure.KPA,
    "KW": UnitOfPower.KILO_WATT,
    "KWH_PER_100KM": UnitOfEnergyDistance.KILO_WATT_HOUR_PER_100_KM,
    ...
    "M_PER_KWH": UnitOfEnergyDistance.MILES_PER_KILO_WATT_HOUR,
